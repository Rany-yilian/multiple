...
import com.im.api.Constants;
import com.im.tools.common.Strings;
...
public class Jsons {
    ...
    public static String toJson(Object bean){
        try {
            ...
            LOGGER.error("json.tojson ex,bean="+bean,e);
        }
        return null;
    }
    ...
    public static <T> T fromJson(String json,Class<T> clazz){
        try {
            ...
            LOGGER.error("json.fromjson ex,json="+json+",clazz="+clazz,e);
        }
        return null;
    }
